...
const Hero = () => {
    return (
        <div className=" -mt-24 mb-9 ">
            <section className=" text-[#f8e9c4] body-font bg-[#0d141b] ">
                <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                        ...
                        <div className="w-[100px] h-[2px] bg-[#3A6B35]"></div>
                        ...
                        <div className="flex justify-center">
                            <Link href={"#contact"}>
                                <button className="inline-flex text-white bg-[#519949] border-0 py-2 px-6 focus:outline-none hover:bg-[#33662e] rounded-2xl text-lg">
                                    Contact
                                </button>
                            </Link>
                    ...
                    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 ">
                        <Image
                            width={500}
                            height={500}
                            className="object-cover object-center rounded-full mx-auto w-60"
                            alt="hero"
                            src={require("../../../public/pictures/profile2.jpg")}
                        />
                    </div>
                </div>
            </section>
